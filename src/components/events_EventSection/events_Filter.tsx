...
const FILTERS = [
  "All Events", "AI", "Data", "Entrepreneur", "Networking", "Tech Workshops", "Virtual", "Tech Talk", "In-Person"
];
    ...
    <div className="flex flex-wrap sm:flex-nowrap sm:flex-col sm:items-start flex-row flex-1 gap-4 font-quicksand text-base sm:text-xl">
      ...
      {FILTERS.map((f) => (
        <button
          key={f}
          type="button"
          className={filter === f ? "text-[var(--color-primary-blue)] font-bold underline" : ""}
