...
const LP_Events = () => {
    ...
    return (
        <section
            ...
            className="py-4 flex flex-col xl:flex-row gap-8 sm:gap-4 justify-between 2xl:mx-auto 2xl:w-full 2xl:max-w-[2300px]"
        >
            <div className="flex-1 flex flex-col justify-between">
                              ...
                              (meetup, index) =>
                                  index < 2 && (
                                      <LP_Event
                                          ...
                                          name={meetup.name}
                                          date={meetup.date}
                                          description={meetup.shortIntro}
                                          iconName={meetup.iconName}
                                          index={index}
                                      />
                                  )
                          )
                ...
                <div className="flex flex-row gap-4 items-center">
                    <Link href="/events" className=" ">
                        <p className="font-medium text-xl font-montserrat underline text-[var(--color-primary-blue)]">
                            View All Events
                        </p>
                    </Link>
