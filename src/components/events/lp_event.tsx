...
const LP_Event = ({ name, date, description, iconName }: EventProps) => {
    return (
        <div className='flex-1 h-full border-[#D9D9D9] border p-4 flex flex-col gap-4 lg:gap-0 justify-between font-quicksand font-normal text-normal xl:text-xl rounded-lg shadow-md'>
