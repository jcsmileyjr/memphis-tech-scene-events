...
const CTAEvents = () => {
    return (
        <section className="flex flex-col-reverse gap-4 md:flex-row-reverse md:gap-8 lg:flex-row lg:gap-0 justify-between items-center pt-8">
            ...
            <div className='flex-1 flex flex-col'>
                ...
                <div className='flex justify-center items-center mt-4'>
                    <button type='button' className="w-1/2 lg:w-1/3 bg-[var(--color-primary-blue)] text-white font-bold text-2xl px-4 py-2 rounded-md ">
                        Submit Event    
                    </button>
                </div>
            </div>
