        ...
        <section className="flex flex-col-reverse gap-4 md:flex-row-reverse md:gap-8 lg:flex-row xl:gap-0 justify-between items-center pt-8 2xl:mx-auto 2xl:w-full 2xl:max-w-[2300px]">
            ...
            <div className="flex-1 flex flex-col">
                <p className="text-xl font-bold font-quicksand">
                    Got an upcoming tech event? Let&#39;s get it seen, shared,
                    and celebrated! Submit it now and we&#39;ll
                    <span className="text-[var(--color-primary-blue)]">
                        {" "}
                        blast it across our newsletter, socials, and community.
                    </span>{" "}
                    Because we believe that great ideas deserve to be supported.
                </p>
                ...
                <p className="text-xl text-red-900 mt-2 text-center">
                    Coming Soon!!!
                </p>
            </div>
        </section>
